...
export class Application {
  ...
  public routes() {
    ...
    router.post('/highscores/normal', index.getHighScoreNormal.bind(index.getHighScoreNormal));
    router.post('/highscores/hard', index.getHighScoreHard.bind(index.getHighScoreHard));
